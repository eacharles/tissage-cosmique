"""Tests for the TensorFlow emulator backend."""
...
from tissage_cosmique.emulators import TensorFlowEmulator, build_training_data, params_to_feature_matrix  # noqa: E402
...
class TestTensorFlowEmulator:
    ...
    def test_save_load_roundtrip(self, fitted_emulator, tmp_path):
        path = tmp_path / "tf_emulator.joblib"
        fitted_emulator.save(path)
        loaded = TensorFlowEmulator.load(path)
